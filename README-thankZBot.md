...
3. Give the bot a handle (ex: `thankZBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://3acf-59-92-24-114.ngrok.io/api/messages`
